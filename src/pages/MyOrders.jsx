              ...
              orders.map((order) => (
                ...
                >
                  ...
                  <td className="py-2 px-2 sm:py-4 sm:px-4">
                   ...
                   <td className="py-2 px-2 sm:py-4 sm:px-4"><span className={`${order.isPaid ? "bg-green-100 text-green-700" : "bg-red-100 text-red-700" } px-2 py-2 rounded-full`}>{order.isPaid ? "Paid" : "Pending"}</span>
